...
// const cars = ["BMW", "Audi", "Benz", "Limousine", "Volvo"];
// cars.length;
// cars[2];

// cars.includes("Tesla");
// cars.slice(1, 3);
// const result = cars.push("Tesla");
// console.log(result);
// cars.push("Toyota");
// cars.unshift("Honda");
...
// cars.sort();
// cars.reverse();
// const newCars = cars.concat(["Lamborghini", "Porsche"]);
...
// newCars.map((val, index) => {
//   console.log(index, val);
// });

// const filteredCars = newCars.filter((car, index) => car.startsWith("L"));
// console.log(filteredCars);

// const favCar = newCars.find((car) => car.startsWith("L"));
// console.log(favCar);
...
//     // the titls is rich poor dad wrire by robert in the year 2001
//   },
// };
// console.log(book);
// // object methods
...
//   workHours: { mon: open },
// } = person;
// // delivery - Lagos and abuja
// // google map {world: {Arg, brazil, canada, Nig: {Osun, Jigawa, lag, ABj}}}

// const users = [
//   {
//     name: "yJohn",
//     userName: "__Johnny123",
//     password: "345678ik4657ifg",
//     age: 32,
//   },
//   { name: "Jane", userName: "jane@23", password: "4567ugibkn", age: 17 },
//   { name: "Mario", userName: "marBoy56", password: "5u768kfhj", age: 45 },
//   { name: "Kerry", userName: "Jnon12345", password: "5u768kfhj", age: 16 },
// ];
// // age >= 18
